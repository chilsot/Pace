...
const deployedAddress = '0x807531B0580BFf535a907F7e8C0B19caeEd76ee4'
...
export const paceAbi = [
  {
    ...
    inputs: [
      ...
      { name: 'waterMl', type: 'uint16' },
      { name: 'reps', type: 'uint16' },
    ],
    outputs: [],
    ...
    outputs: [
      {
        ...
        type: 'tuple',
        components: [
          { name: 'recordedDays', type: 'uint64' },
          { name: 'totalSteps', type: 'uint64' },
          { name: 'totalWaterMl', type: 'uint64' },
          { name: 'totalReps', type: 'uint64' },
          { name: 'checkIns', type: 'uint64' },
          { name: 'lastCheckInDay', type: 'uint64' },
          { name: 'bestDayScore', type: 'uint64' },
